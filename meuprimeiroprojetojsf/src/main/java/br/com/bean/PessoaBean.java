...
public class PessoaBean {
	...
	public String deslogar() {
		 ...
		 HttpServletRequest httpServletResquest =  (HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest();
		 
		httpServletResquest.getSession().invalidate();
