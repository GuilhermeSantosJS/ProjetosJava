...
public class UserPosDao {
	...
	public void Salvar(Userposjava Userposjava){
		try {
			...
			try {
				connection.rollback(); // reverte iteração
	...
	public void  salvarTelefone(Telefone telefone) {
		try {
			...
			String sql = "INSERT INTO  telefoneuser (numero, tipo, usuaripessoa) VALUES (?, ?, ?);";
	...
	public List<BeanUserFone> listaUserFone (Long idUser){
		...
		sql += " on fone.usuaripessoa = userp.id ";
	...
	public void deleteFonesPorUser(Long idUser) { 
		try {
		String sqlFone =  "delete from telefoneuser where usuaripessoa = " + idUser;
